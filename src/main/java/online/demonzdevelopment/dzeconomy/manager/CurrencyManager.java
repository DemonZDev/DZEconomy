...
import online.demonzdevelopment.dzeconomy.cache.BalanceCache;
...
public class CurrencyManager {
    ...
    /**
     * Get all loaded players (alias for migration)
     */
    public Collection<PlayerData> getAllLoadedPlayers() {
